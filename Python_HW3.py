...
#  то вывести в консоль (“Переменная с”, comp_item)
...
#  27. Сделать if в котором будет условие: если c, то вывести в консоль
...
# 31.3 Создать переменную target_currency_amount co значением 50
